...
class Trainer(object):
    ...
    def train(self, train_iter, epoch, report_func=None, portions=None):
        """ Train next epoch.
        Args:
    ...
    def drop_checkpoint(self, opt, epoch, fields, valid_stats, train_portion):
        ...
        torch.save(checkpoint,
                   '%s_acc_%.2f_ppl_%.2f_e%d_p%d.pt'
                   % (opt.save_model, valid_stats.accuracy(),
                      valid_stats.ppl(), epoch, train_portion))
